    ...
    ORDER BY posts.created_at DESC;`)
      .then(data => {
        ...
        for(let i=0; i < data.length; i++){
          ...
          const value = await db.query(`SELECT users.id as users_id, users.username as username, users.user_image as user_image, comments.comment as comment, comments.likes as comment_likes, comments.comment_image as comment_image, comments.created_at as comment_created_at, comments.post_id as post_id
          FROM comments
